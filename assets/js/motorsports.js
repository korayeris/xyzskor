(() => {
  ...
  const series = {
    ...
    moto2: { label: 'Moto2', accent: '#ef914a', discipline: 'Motosiklet', category: 'motorcycle', classification: 'Orta sınıf', pickerMeta: '765 cc · ara sınıf', mark: 'M2', photo: 'moto2' },
    moto3: { label: 'Moto3', accent: '#efb04a', discipline: 'Motosiklet', category: 'motorcycle', classification: 'Hafif sınıf', pickerMeta: '250 cc · gelişim', mark: 'M3', photo: 'moto3' },
  ...
  const motorsportPhotos = {
    ...
    moto2: { file: '/assets/images/motorsports/legal/moto2-cc.webp', creator: 'Liauzh', source: 'https://commons.wikimedia.org/wiki/File:Moto2_2024_Malaysian_Grand_Prix_-_Idemitsu_Honda_Team_Asia_-_Somkiat_Chantra.jpg', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0/' },
    moto3: { file: '/assets/images/motorsports/legal/moto3-cc.webp', creator: 'Liauzh', source: 'https://commons.wikimedia.org/wiki/File:Moto3_2024_Malaysian_Grand_Prix_-_Honda_Team_Asia_-_Tatchakorn_Buasri.jpg', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0/' },
