...
assert.match(appSource, /\{ key:'super-lig'[\s\S]*\{ key:'premier-league'[\s\S]*\{ key:'la-liga'[\s\S]*\{ key:'all'/i, 'Lig seçimi Süper Lig, Premier League, La Liga ve Tüm ligler sırasını korumalı.');
